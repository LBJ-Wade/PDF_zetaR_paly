...
JacobiPDE::JacobiPDE(vector< vector< vector<double> > > &Site, vector<double> &It, vector<double> &Params)
{
...
double JacobiPDE::PDE_1step(int num, int func)
{
  ...
  double uu = CC(num,PSV0,func), coeff = DD(PSV0,func); // coeff = 0;
